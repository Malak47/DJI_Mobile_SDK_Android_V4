...
public class ILM_UploadMissions {
    private Context context;
    private String fileName;

    public ILM_UploadMissions(Context context, String fileName) {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                if (counter != 0) {
                    ...
                    waypoints.addWaypoint(waypoint[1], waypoint[0], String.valueOf(8), counter - 1);
